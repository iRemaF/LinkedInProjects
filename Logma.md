...
> A bilingual iOS application (Arabic/English) that leverages AI to transform restaurant menus into a clear, personalized guide for safe dining.  

---

## Project Overview  
**Logma** is a fully functional iOS application designed to help individuals with food allergies make informed dining decisions.  

- Scan any restaurant menu using the camera.  
...
## Key Features  
- Menu scanning with OCR and AI-powered ingredient analysis  
- Personalized allergy profiles with dynamic adaptation  
- Clear safety indicators for each dish  
- Smart prompts for communicating with restaurant staff  
- Structured result page for clarity and speed  
- Privacy-conscious design with minimal data retention  
